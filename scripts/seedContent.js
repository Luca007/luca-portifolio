...
var content_1 = require("../src/i18n/content");
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var email, password, app, auth, userCred, db, _i, _a, _b, lang, data;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    console.log('⚙️  Firebase Content Seeding Utility');
                    email = readlineSync.questionEMail('Enter your Firebase user email: ');
                    password = readlineSync.question('Enter your Firebase password: ', { hideEchoBack: true });
                ...
                case 1:
                    userCred = _c.sent();
                    console.log("\u2705 Signed in as ".concat(userCred.user.email));
                    db = (0, firestore_1.getFirestore)(app);
                    _i = 0, _a = Object.entries(content_1.contentMap);
                    _c.label = 2;
                case 2:
