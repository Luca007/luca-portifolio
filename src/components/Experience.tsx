...
// Types for experience card props
type ExperienceItem = {
  company: string;
  position: string;
  period: string;
...
const ExperienceCard = ({ experience, index, isAdmin, isEditMode, handleEdit }: ExperienceCardProps) => {
        ...
        <CardContent className="p-6">
          <div className="flex flex-col space-y-4">
            ...
            {experience.responsibilities.length > 0 && (
              <div>
                <h4 className="font-medium mb-2">{content.experiences.responsibilitiesTitle}</h4>
