...
export default function StickyNavHeader() {
  ...
  return (
    <div className="sticky-header-container">
      <header
        className={cn(
          "sticky top-0 left-0 z-[9999] py-3 transition-all duration-200 w-full",
          isScrolled
            ? "bg-background/95 backdrop-blur-lg shadow-md"
            : "bg-background/50 backdrop-blur-sm"
        )}
        style={{
          position: 'sticky',  // The key property for sticky behavior
          top: 0,              // Required for sticky positioning to work
          zIndex: 9999,
        }}
      >
